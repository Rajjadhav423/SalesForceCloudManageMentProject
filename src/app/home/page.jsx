                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        aria-current={
                          activeCloud === item.id ? "page" : undefined
                        }
                      >
                        <span
                          className={`${
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="outline"
                  className={`w-full mb-2 flex items-center justify-${
                    sidebarCollapsed ? 'center' : 'start'
                  } gap-2 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400 transition-colors rounded-lg`}
                  asChild
                >
                  <Link href="/dashboard">
              ...
              <TooltipTrigger asChild>
                <Button
                  ...
                  className={`w-full flex items-center justify-${
                    sidebarCollapsed ? 'center' : 'start'
                  } rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 dark:hover:text-red-400 transition-colors`}
                >
                  {loading ? (
            ...
            {session?.user && (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="rounded-full h-10 px-2 flex items-center gap-2"
                  >
